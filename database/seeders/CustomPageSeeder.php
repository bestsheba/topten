...
class CustomPageSeeder extends Seeder
{
    ...
    public function run(): void
    {
            ...
            [
                ...
                'page' => [
                    ...
                    [
                        ...
                        'slug' => 'delivery-and-return',
                        'description' => 'Delivery & Return',
                    ],
        ...
        foreach ($pages as $groupData) {
            $group = CustomPageGroup::create([
                'name' => $groupData['group'],
                'sort_order' => $groupSortOrder++,
            ]);
            $groups[$groupData['group']] = $group;
        }
        
        // Then, create all the pages
        $sortOrder = 1;
        
        foreach ($pages as $groupData) {
            $group = $groups[$groupData['group']];
            
            foreach ($groupData['page'] as $pageData) {
                CustomPage::create([
                    'title' => $pageData['title'],
                    'slug' => $pageData['slug'],
                    'description' => $this->description(),
                    'custom_page_group_id' => $group->id,
    ...
    <div class="mx-auto px-8 !py-[20px]" style="padding:20px">
