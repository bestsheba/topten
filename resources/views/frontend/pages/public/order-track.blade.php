                                ...
                                <div class="flex flex-col md:flex-row md:items-center md:justify-between">
                                    <div>
                                        <h2 class="text-xl font-semibold text-gray-900">
                                            Order: <span id="public-order-id">{{ $order->hashed_id }}</span>
                                            <button class="btn btn-sm btn-light" id="copy-public-order-id-btn" title="Copy Order ID">
                        ...
                        <div class="bg-red-50 border border-red-200 rounded-lg p-6 text-center">
                            ...
                            <div class="text-sm text-red-600">
                                ...
                                <ul class="list-disc list-inside space-y-1">
                                    ...
                                    <li>The order number is valid</li>
                                </ul>
                            </div>
                        </div>
                    </div>
...
@push('scripts')
<script>
    const btn = document.getElementById('copy-public-order-id-btn');
    if (btn) {
        btn.addEventListener('click', function () {
            const text = document.getElementById('public-order-id').innerText;
