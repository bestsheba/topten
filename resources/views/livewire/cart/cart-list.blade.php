    ...
    @foreach ($carts as $key => $cart)
        @php
            ...
            $attributes = $variation?->attributeValues
                ...
                ->join(', ');
        @endphp
        <div class="flex flex-col md:flex-row items-start md:items-center justify-between bg-white shadow border rounded-xl p-4 mb-4">
            ...
            <div class="flex items-center gap-3 mt-3 md:mt-0 md:w-auto">
                <div class="flex">
                    <button wire:click="changeQuantity('{{ $key }}', '-')"
