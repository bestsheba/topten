                        ...
                        <form action="{{ route('admin.landing-pages.update', $landingPage->id) }}" method="POST"
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="title"
                                    ...
                                    value="{{ old('title', $landingPage->title) }}" placeholder="Enter landing page title">
                                @error('title')
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="url" class="form-control @error('url') is-invalid @enderror"
                                    value="{{ old('url', $landingPage->url) }}" placeholder="Enter landing page URL">
                                @error('url')
                                    <span class="invalid-feedback">{{ $message }}</span>
                                @enderror
                            </div>
